...
import { index as curricula, store as curriculaStore } from '@/routes/curricula';
import type { CurriculaFormProps } from '@/types';
import AppLayout from '@/layouts/app-layout';

export default function Create({ programs, subjects, semesterTypes }: CurriculaFormProps) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        semester_type: 'first',
        is_required: true,
        prerequisite_subjects: [] as number[],
        units_override: '',
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(curriculaStore.url());
    };
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                ...
                <Card className="max-w-2xl">
                    <CardHeader>
                        <CardTitle>Create New Curriculum Entry</CardTitle>
                    </CardHeader>
                    <CardContent>
