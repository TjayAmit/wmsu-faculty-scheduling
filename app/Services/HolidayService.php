...
class HolidayService
{
    ...
    public function create(Request $request): Holiday
    {
        ...
        DB::transaction(function () use ($request, &$model, &$dto) {
            $dto = HolidayData::fromRequest($request);
    ...
    public function update(Request $request, Holiday $model): Holiday
    {
    ...
    public function delete(Holiday $model): bool
    {
        $data = $model->toArray();
        $result = false;
