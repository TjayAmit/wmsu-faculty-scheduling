...
import { index as substituteRequests, store as substituteRequestsStore } from '@/routes/substitute-requests';
import type { SubstituteRequestsFormProps } from '@/types';
import AppLayout from '@/layouts/app-layout';

export default function Create({ teachers }: SubstituteRequestsFormProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(substituteRequestsStore.url());
    };

    return (
        <>
            <Head title="Create Substitute Request" />
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                ...
                <Card className="max-w-2xl">
                    <CardHeader>
                        <CardTitle>Create New Substitute Request</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center gap-4 pt-4">
                                ...
                                <Button variant="outline" asChild>
                                    <Link href={substituteRequests()}>Cancel</Link>
                                </Button>
                            </div>
                        </form>
                    </CardContent>
