...
import { MoreVertical, Pencil, Trash2, Eye, Calendar } from 'lucide-react';
...
export default function Index({ data, filters }: SemestersIndexProps) {
...
return;
        ...
        setIsDeleting(true);
        router.delete(semestersDestroy(deleteId), {
            onFinish: () => {
                setIsDeleting(false);
                setDeleteId(null);
            },
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4 lg:p-6">
                <div className="overflow-hidden rounded-xl border border-border bg-card shadow-sm">
                    ...
                    <TablePageHeader
                        ...
                        createHref={semestersCreate().url}
                            ...
                            {data.data.length === 0 ? (
                                ...
                                data.data.map((item) => (
                                    <TableRow
                                        ...
                                        onClick={() => router.get(semestersShow(item.id))}
                                    >
                                        ...
                                        <TableCell className="px-4 py-3.5 text-sm text-muted-foreground">
                                            {semesterTypeLabels[item.semester_type]}
                                        </TableCell>
                                        ...
                                        >
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="w-40">
                                                    <DropdownMenuItem onClick={() => router.get(semestersShow(item.id))}>
                                                        <Eye className="mr-2 h-4 w-4" />
                                                        View
                                                    </DropdownMenuItem>
                                                    <DropdownMenuItem onClick={() => router.get(semestersEdit(item.id))}>
